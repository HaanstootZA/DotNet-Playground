...
namespace MappingApplication
{
    class PageNode
    {
        ...
        public PageNode(Page Page, PageNode Parent) {
            ...
            m_font = new Font("Calibri", 8, FontStyle.Regular);
        }
        ...
        public void SetDot(MPoint Origin, ref Bitmap bmp)
        {
            try
            {
                ...
                g.DrawRectangle(Pens.Black, pos.iX, pos.iY, s.Width + 1, s.Height + 1);
                pos += 1;
                g.FillRectangle(Brushes.White, pos.iX, pos.iY, s.Width - 1, s.Height);
                pos -= 1;
